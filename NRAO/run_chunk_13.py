...
if 'S' in stagestring:
    ...
    this_uvh.set_line_products(only=['13co21'])
...
if 'I' in stagestring:
    ...
    this_imh.set_line_products(only=['13co21'])
...
if 'P' in stagestring:
    ...
    this_pph.set_feather_configs(only=['13co21'])
...
if do_imaging:
    this_imh = ImagingChunkedHandler(target, '12m+7m', '13co21', this_kh,
...
if do_derived:
    ...
    this_der.set_line_products(only=['13co21'])
