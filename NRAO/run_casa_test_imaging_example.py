...
sys.path.append("/lustre/cv/users/rindebet/local/github/phangs_imaging_scripts")

# Location of the master key. Set this to the master key that points
# to all of the keys for your project.

key_file = '/lustre/cv/users/rindebet/local/github/phangs_imaging_scripts/NRAO/master_key_sscales.txt'
...
if do_imaging_tests:
    ...
    robusts = np.round(np.arange(-0.5, 1.6, 0.5), 2)
    ...
    # Suggested weighting:
    suggestion = this_tih.suggest_optimal(target_resolution_arcsec=0.5)
